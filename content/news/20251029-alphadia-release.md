...
{{< figure-caption 
    image="/images/content/alphadia_fig1c-e.png"
    name="alphaDIA: Precursor identification"
    caption="_Figure: [Wallmann et al, 2025, Nature Biotech](https://doi.org/10.1038/s41587-025-02791-w)_." 
>}}
...
{{< figure-caption 
        image="/images/content/alphadia_fig1a.png" 
        name="alphaDIA: Integration into alphaPept eocsystem" 
        caption="Components of alphaDIA and the integration into the alphaPept ecosystem. AlphaDIA uses [*alphaRaw*](https://github.com/MannLabs/alpharaw.git) and [*alphaTims*](https://github.com/MannLabs/alphatims.git) for accessing raw data from all major vendors. Importing and prediction of spectral libraries are facilitated by [*alphaBase*](https://github.com/MannLabs/alphabase.git) and [*alphapeptdeep*](https://github.com/MannLabs/alphapeptdeep.git). After successful search, LFQ is performed using [*directLFQ*](https://github.com/MannLabs/directlfq.git) (_Figure: [Wallmann et al, 2025, Nature Biotech](https://doi.org/10.1038/s41587-025-02791-w), BioRender_)."
>}}
...
We warmly invite the community to [**explore the package**](https://alphadia.readthedocs.io/en/latest/guides.html), and [**contribute**](https://alphadia.readthedocs.io/en/latest/developer_guide.html) to [alphaDIA on GitHub](https://github.com/MannLabs/alphadia.git). Together, we can continue to advance the open, modular, and intelligent future of computational proteomics.
